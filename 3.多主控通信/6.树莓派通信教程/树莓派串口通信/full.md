...
![](images/89631401cc832a18a0b4e7d5d4af730c26a6d377859859422bc3699f3366f335.jpg)
...
![](images/4b35c7ee6b44ea348190a40002669cf0cc9e437c63641e5e9825b7825a0dbc82.jpg)
...
```yaml
- yahboom@raspberrypi:~ $ ls /dev/ttyUSB* /dev/ttyUSB0
- yahboom@raspberrypi:~ $ 
```
...
```txt
○ yahboom@raspberrypi:~ $ python3 uart_test.py
