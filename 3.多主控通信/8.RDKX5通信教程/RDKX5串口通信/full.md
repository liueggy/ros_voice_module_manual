...
![](images/e0bf13753cc2d8f7f0404ddea9ec7b45e1beb00ef085904e49e78d183a1c99d5.jpg)
...
![](images/7845c723af5b43f78d18cec3f9e9833e6674c7cd63228ce780379839c476d81b.jpg)
...
```txt
- sunrise@ubuntu:~/Downloads$ ls /dev/ttyUSB* /dev/ttyUSB0
- sunrise@ubuntu:~/Downloads$ 
```
...
```txt
sunrise@ubuntu:~/Downloads$ python3 uart_test.py Speech Serial Opened! Baudrate=115200 
```

当我说出唤醒词唤醒之后，说“关灯”调试助手会回复接收10

```txt
sunrise@ubuntu:~/Downloads$ python3 uart_test.py
